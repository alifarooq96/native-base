...
export const metadata: Metadata = {
  ...
  description:
    'Stop rekeying data into the Progressive Agent Portal. NativeBase uses AI browser automation to prefill forms and deliver a bindable quote in under 5 minutes.',
  openGraph: {
    title:
