...
export const metadata: Metadata = {
  ...
  description:
    'Stop rekeying into five different carrier portals. NativeBase AI automation fills Progressive, Travelers, Liberty Mutual, and more from a single upload—bindable quotes in under 5 minutes.',
  openGraph: {
    title:
