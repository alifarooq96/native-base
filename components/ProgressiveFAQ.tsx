...
const faqs = [
  ...
  },
  {
    ...
    a: 'Yes. The same AI automation technology works across carrier portals—Travelers, Liberty Mutual, Safeco, and more. Progressive is just one of the many portals we support.',
  },
  {
